...
if (typeof window !== 'undefined' && !window.api) {
  const ipcMapping = {
    ...
    getRestaurantZones: 'get-restaurant-zones',
    addRestaurantZone: 'add-restaurant-zone',
    deleteRestaurantZone: 'delete-restaurant-zone',
    saveProductRecipe: 'save-product-recipe',
    getProductRecipe: 'get-product-recipe',
    produceSemiFinished: 'produce-semi-finished',
    getSubWarehouses: 'get-sub-warehouses',
    addSubWarehouse: 'add-sub-warehouse',
    createStockTransfer: 'create-stock-transfer',
    getStockTransfers: 'get-stock-transfers',
    ...
    getKitchenHistory: 'get-kitchen-history',
    setOrderStatus: 'set-order-status',
    setOrderItemStatus: 'set-order-item-status',
    setOrderServed: 'set-order-served',
    revertKitchenOrderStatus: 'revert-kitchen-order',
    getKitchenPerformanceReport: 'get-kitchen-performance',
    getDirectorOverview: 'get-director-overview',
    setOrderStatusByTable: 'set-order-status-by-table',
    getTvOrders: 'get-tv-orders',
    toggleProductStop: 'toggle-product-stop',
    setProductStopWithLimit: 'set-product-stop-with-limit',
